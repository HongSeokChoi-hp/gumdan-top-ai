...
# ============================================================
# 🎨 [핵심 수정] 글씨 색상, 카톡 UI(하단 고정), 슬림 헤더 완벽 적용
# ============================================================
st.markdown("""
<style>
    ...
    * { font-family: 'Pretendard', sans-serif; }
    ...
    /* 🚨 1. 무식하게 크던 상단 헤더 -> 슬림하게 축소 및 상단 고정 */
    .enterprise-header { 
        background: linear-gradient(135deg, #002b5e 0%, #005691 100%); 
        padding: 8px 15px; /* 여백 대폭 축소 */
        border-radius: 8px; 
        margin-top: 10px;
        margin-bottom: 5px;
        ...
        align-items: center;
        gap: 10px;
        position: sticky; /* 스크롤해도 상단에 유지 */
        top: 0;
        z-index: 1000;
    }
    
    /* 🚨 2. 까맣게 타버린 글씨 복구 -> 헤더 안의 글씨는 무조건 100% 흰색 */
    .enterprise-header h1, .enterprise-header p, .enterprise-header span { 
        margin: 0; 
        font-size: 1.15rem !important; /* 폰트 크기 축소 */
        font-weight: 800; 
        color: #ffffff !important; 
    }
    .enterprise-header img { height: 26px !important; } /* 로고 크기 축소 */
    
    /* 🚨 3. 채팅창 밑바닥 영구 고정 (카톡 UI의 핵심) */
    [data-baseweb="tab-panel"] {
        min-height: 75vh !important; /* 화면 높이를 확보해서 입력창을 바닥으로 밀어냄 */
    }
    [data-testid="stChatInput"] { 
        position: sticky !important; /* 화면 밑바닥에 본드처럼 고정 */
        bottom: 0 !important;
        background-color: #F8FAFC !important; /* 뒤에 스크롤되는 글씨 가리기 */
        z-index: 9999 !important;
        padding-bottom: 25px !important;
        padding-top: 10px !important;
        border-top: 1px solid #e2e8f0;
    }
    [data-testid="stChatInput"] textarea { color: #111827 !important; } /* 입력하는 글씨 색상 */
    ...
    /* 모바일 탭 글씨 짤림 방지 */
    button[data-baseweb="tab"] p { font-size: 0.95rem !important; font-weight: 700; white-space: normal !important; text-align: center; }
</style>
