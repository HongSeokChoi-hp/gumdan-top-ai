...
# ============================================================
# 🎨 UI 고급화 및 [허공에 뜬 입력창 맨 밑바닥 강제 고정] CSS
# ============================================================
st.markdown("""
<style>
    ...
    * { font-family: 'Pretendard', sans-serif; }
    ...
    .block-container { 
        ...
        padding-bottom: 0rem !important; /* 하단 빈 공간 삭제 */
    ...
    /* ============================================================
       🚨 [핵심 해결] 입력창을 맨 밑바닥으로 밀어내는 Flexbox 마법 
       ============================================================ */
    
    /* 1. 탭 안쪽 영역을 화면 끝(100dvh)까지 강제로 팽창시킴 */
    div[data-baseweb="tab-panel"] {
        min-height: calc(100dvh - 180px) !important; /* 화면 높이에서 배너 높이만 뺌 */
        display: flex !important;
        flex-direction: column !important;
    }
    
    /* 2. 스트림릿 내부 컨테이너들도 같이 늘어나게 설정 */
    ...
    /* 3. 대화 내용이 비어있어도 입력창을 무조건 맨 밑으로 밀어버림 (margin-top: auto) */
