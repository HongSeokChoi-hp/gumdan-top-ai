...
def load_intelligent_db():
    ...
    # 지적 4: 임베딩 모델 호환성 문제 해결 (004 시도 후 001 폴백)
    try:
        ...
        try:
            ...
            return vdb, "구형 인덱스(001)로 호환 로드되었습니다."
        except Exception as e2:
            # 지적 3: 예외 삼키지 않고 반환
            return None, f"FAISS 로드 오류 (004 실패: {e1} / 001 실패: {e2})"
