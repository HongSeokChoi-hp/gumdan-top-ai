...
<style>
    ...
    * { font-family: 'Pretendard', sans-serif; }
    ...
    .block-container { 
        ...
        max-width: 1200px !important; /* PC에서 너무 퍼지지 않게 최적화 */
    }
    ...
    /* 🚨 [핵심] 제미나이처럼 탭 영역이 화면 끝까지 늘어나도록 강제 */
...
with tab1:
    # 🚨 상자 가두기 폐지! 이제 탭 내부 전체를 시원하게 사용합니다.
